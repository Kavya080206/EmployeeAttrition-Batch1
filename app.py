...
st.sidebar.markdown("Fill in the employee information below.")
...
def user_input_features():
    ...
    inputs["OverTime"] = st.sidebar.selectbox("Over Time", ["Yes", "No"])   # FIXED HERE
...
# encode the 'OverTime' feature only if present
